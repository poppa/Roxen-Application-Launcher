...
static void _lambda4_ (RoxenlauncherApplicationForm* self);
...
static void _lambda5_ (RoxenlauncherFileDialog* self);
static void __lambda5__gtk_object_destroy (GtkObject* _sender, gpointer self);
...
void roxenlauncher_application_form_run (RoxenlauncherApplicationForm* self) {
	...
	g_signal_connect_object (self->priv->btn_browse, "clicked", (GCallback) __lambda4__gtk_button_clicked, self, 0);
...
RoxenlauncherFileDialog* roxenlauncher_file_dialog_construct (GType object_type) {
	...
	g_signal_connect_object ((GtkObject*) self, "destroy", (GCallback) __lambda5__gtk_object_destroy, self, 0);
	return self;
}
